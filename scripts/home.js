  //------------------------------------------------------------------------------//---------------------------------------------------------------------------//
        ...
        let count = 1
        console.log(count)
        url = `https://urban-out-fitters-backend.herokuapp.com/homes?page=1&size=12`
        function next_page(){
            ...
            console.log(count+1)
            url = `https://urban-out-fitters-backend.herokuapp.com/homes?page=${count}&size=12`
            getUser()
        }
...
document.getElementById("bysize_").addEventListener("change", async()=>{
  ...
  url = `https://urban-out-fitters-backend.herokuapp.com/homes`
